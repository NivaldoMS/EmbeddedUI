#ifndef MENU_HIERARCHY_MONITOR_WEB_PAGE_H
#define MENU_HIERARCHY_MONITOR_WEB_PAGE_H
...
<head>
    ...
    <title>Monitor Hierárquico do Menu</title>
...
<body>
    ...
    <main>
        ...
        <header>
            ...
            <h1>
                Monitor Hierárquico do Menu
            </h1>

            <div class="description">
                Visualização passiva da estrutura e do estado da EmbeddedUI.
            </div>
    ...
    <script>
        ...
        /*
         * Guarda o estado de expansão dos
         * itens do primeiro nível.
         *
         * A chave é formada pela posição e
         * pelo título do item.
         */
